...
file_worker = FileStorage("timeline.json")
tweets = []
twitter_account = "DjMaRiiO"
num_tweets = 200
for status in tweepy.Cursor(api.user_timeline, screen_name=twitter_account, tweet_mode='extended').items(num_tweets):
